...
public final class  HttpUploadClient {
    ...
    static final String BASE_URL = System.getProperty("baseUrl", "netty03http://127.0.0.1:8080/");
    static final String FILE = System.getProperty("file", "netty04upload.txt");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String scheme = uriSimple.getScheme() == null? "netty03http" : uriSimple.getScheme();
        String host = uriSimple.getHost() == null? "127.0.0.1" : uriSimple.getHost();
        int port = uriSimple.getPort();
        if (port == -1) {
            if ("netty03http".equalsIgnoreCase(scheme)) {
                port = 80;
        ...
        if (!"netty03http".equalsIgnoreCase(scheme) && !"https".equalsIgnoreCase(scheme)) {
    ...
    /**
     * Standard usage of HTTP API in Netty without file Upload (get is not able to achieve File netty04upload
